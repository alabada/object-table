    ...
    $scope.data1 = [
      {
        ...
        friends: [
          {"name": "Grace Hanson", "id": 0},
          {"name": "Carlene Whitley", "id": 1},
          {"name": "Cassandra Parsons", "id": 2}
        ],
        favoriteFruit: "food",
        isSpread: "true"
      },
      {
        ...
        friends: [
          {"name": "Marta Crane", "id": 0},
          {"name": "Lela Pearson", "id": 1},
          {"name": "Casandra Finley", "id": 2}
        ],
      ...
      },
      {
        ...
        friends: [
          {"name": "Celina Hopper", "id": 0},
          {"name": "Janet Huffman", "id": 1},
          {"name": "Decker Moody", "id": 2}
        ],
        favoriteFruit: "hhhh",
        isSpread: "true"
      }
